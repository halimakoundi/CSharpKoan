...
{
	public class J_AboutContainers : Koan
	{
		[Koan(1)]
		public void A_ArrayListSizeIsDynamic()
		{
		...
		[Koan(2)]
		public void B_ArrayListHoldsObjects()
		{
			ArrayList list = new ArrayList();
		...
		[Koan(3)]
		public void C_MustCastWhenRetrieving()
		{
		...
		[Koan(4)]
		public void D_ArrayListIsNotStronglyTyped()
		{
		...
		[Koan(6)]
		public void F_ABetterDynamicSizeContainer()
		{
		...
		[Koan(7)]
		public void G_ListWorksWithAnyType()
		{
		...
		[Koan(8)]
		public void H_InitializingWithValues()
		{
		...
		[Koan(9)]
		public void I_AddMultipleItems()
		{
		...
		[Koan(12)]
		public void L_ConvertingToFixedSize()
		{
			List<int> list = new List<int> { 1, 2, 3 };
			Assert.AreEqual(FILL_ME_IN, list.ToArray());
		}
		[Koan(13)]
		public void M_InsertingInTheMiddle()
		{
			List<int> list = new List<int> { 1, 2, 3 };
			list.Insert(1, 6);
			Assert.AreEqual(FILL_ME_IN, list.ToArray());
        ...
        [Koan(15)]
        public void O_RemovingItemsAtACertainPosition()
        {
        ...
        [Koan(19)]
        public void S_PeekingIntoAStack()
        {
        ...
        [Koan(21)]
        public void U_PeekingIntoAQueue()
        {
        ...
        [Koan(22)]
		public void V_AddingToADictionary()
		{
		...
		[Koan(24)]
		public void X_AccessingDataNotAdded()
		{
			Dictionary<string, string> dictionary = new Dictionary<string, string>();
			dictionary["one"] = "uno";
		...
		[Koan(25)]
		public void Y_CatchingMissingData()
		{
		...
		[Koan(26)]
		public void Z_PreCheckForMissingData()
		{
			Dictionary<string, string> dictionary = new Dictionary<string, string>();
			dictionary["one"] = "uno";
			string result;
		...
		[Koan(27)]
		public void ZA_TryGetValueForMissingData()
		{
			Dictionary<string, string> dictionary = new Dictionary<string, string>();
			dictionary["one"] = "uno";
			string result;
		...
		[Koan(28)]
		public void ZB_InitializingADictionary()
		{
