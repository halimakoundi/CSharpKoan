...
{
    public class B_AboutClassesAndStructs : Koan
    {
        class Example1
        {
            public Example1()
        ...
        public void A_FieldsAndMethods()
        {
            ...
            // call a method:
            Assert.AreEqual(FILL_ME_IN, obj.GetSquareOfA());
            ...
            Assert.AreEqual(FILL_ME_IN, obj.GetB());
        }
        [Koan(2)]
        ...
        public void E_PassingAnObjectOfAClassIsByReference()
        {
            ...
            obj.n = 1;
            Assign5ToN(obj);
            Assert.AreEqual(FILL_ME_IN, obj.n);
        }
